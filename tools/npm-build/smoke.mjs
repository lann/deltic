...
//   2. Brands cross package boundaries: a value branded by the runtime is
//      recognized by the protocol package's predicate, on the registry symbols.
//   3. The pipeline runs: load the packaged translator, translate a real guest
//      component, instantiate it, call an export, check the answer.
//   4. The SHIPPED .d.ts type-check from outside, against the installed
...
try {
  ...
  npm(["install", "--no-audit", "--no-fund", "--save-dev", "typescript@5"], project);
